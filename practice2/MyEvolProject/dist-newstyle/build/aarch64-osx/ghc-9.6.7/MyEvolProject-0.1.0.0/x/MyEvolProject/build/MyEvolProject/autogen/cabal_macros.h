...
/* package MyEvolProject-0.1.0.0 */
#ifndef VERSION_MyEvolProject
#define VERSION_MyEvolProject "0.1.0.0"
#endif /* VERSION_MyEvolProject */
#ifndef MIN_VERSION_MyEvolProject
#define MIN_VERSION_MyEvolProject(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_MyEvolProject */
...
#define CURRENT_COMPONENT_ID "MyEvolProject-0.1.0.0-inplace-MyEvolProject"
